    ...
    def say(score0, score1):
        ...
        if score > last_score:
            ...
            if running > running_high:
                running_h = running
                print(running_h, 'point(s)! The most yet for Player',who)
...
def bacon_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    fbscore = free_bacon(opponent_score)
    if(fbscore >= cutoff):
        return 0
    else:
        return num_rolls
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    tempscore = free_bacon(opponent_score)
    if (extra_turn(score+tempscore,opponent_score)):
        return 0
    elif(tempscore >= cutoff):
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
